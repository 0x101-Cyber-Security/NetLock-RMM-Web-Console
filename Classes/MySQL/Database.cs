...
";
  ...
  ""settings_protocols_enabled"": true
                ...
                await Classes.MySQL.Handler.Execute_Command("INSERT INTO accounts (username, password, reset_password, role, permissions) VALUES ('admin', '" + password + "', 1, 'Administrator', '" + permissions + "');");
